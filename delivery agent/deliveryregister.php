...
if (isset($_POST["sub"])) {
    $deliveyagent_name = $_POST["d_name"];
    // echo $deliveyagent_name;
    $email = $_POST["d_email"];
    // echo $email;
    ...
    $addss = $_POST["d_address"];
    // echo $addss;
    mysqli_query($con, "INSERT INTO `tbl_delivery` (`d_name`, `d_email`, `d_phone`, `d_address`, `password`, `status`) VALUES ('$deliveyagent_name','$email',$ph,'$addss','$passw','Approved')");
                ...
                <div class="reg-box2">
                    <form action="#" method="post" name="form1" enctype="multipart/form-data" onSubmit="return val()">
                        <table>
                            <tr>
                                <th colspan="2">
                                    <h1>Create an new Staff Account</h1>
                                </th>
                            </tr>
                            <tr>
                                <td><label for="na">Delivery Agent Name:</label></td>
                                <td class="inpt"><input autofocus autocomplete="off" oninput="fnamecheck();" type="text" id="na" name="d_name" placeholder="Enter the society name" required></td>
                                <td> <span style="color:red; font-size:12px;" id="out_fname"></span></td>
                            </tr>
                            <tr>
                                <td><label for="mn">Mobile number:</label></td>
                                <td class="inpt"><input autofocus autocomplete="off" type="text" id="mn" name="d_phone" oninput="mobilecheck();" placeholder="Enter your mobile number" required></td>
                                <td> <span style="color:red;font-weight:bold;font-size:12px;" id="out_mobile"></span></td>
                            </tr>
                            <tr>
                                <td><label for="em">Email id:</label></td>
                                <td class="inpt"><input autofocus autocomplete="off" type="email" id="em" name="d_email" oninput="mailcheck();" placeholder="Enter your email id" required></td>
                                <td><span style="color:red; font-size:12px;" id="out_email"></span></td>
                            </tr>
                            <tr>
                                <td><label for="a2">Address:</label></td>
                                <td class="inpt"><textarea row="20" column="20" name="d_address" id="a2" placeholder="Enter your address......" required></textarea></td>
                            </tr>


                            <tr>
                                <td><label for="pas">Password:</label></td>
                                <td class="inpt"><input autofocus autocomplete="off" type="password" id="pas" name="password" oninput="pass1check();" placeholder="Enter your password" required></td>
