...
<body>
    ...
    <nav class="w3-bar w3-black">
        <ul>
            ...
            <li><a href="deliveryregister.php">Register</a></li>
    ...
    <div class="main-banner" id="top">
        <div id="frm1">
            ...
            <section class="section-log">
                ...
                <div class="log-box2">
                    <form action="./d_login_check.php" method="post" enctype="multipart/form-data">
                        ...
                        <p id="tt">Not yet a memeber? <a href="deliveryregister.php">Register</a></p>
