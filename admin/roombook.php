    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
				...
				<li>
                        <a  href="home.php"><i class=""></i> Status</a>
                    </li>
                    
					
                    <li>
                        <a href="payment.php"><i class=""></i> Payment</a>
                    </li>
					<li>
                        <a  href="profit.php"><i class=""></i> Profit</a>
                    </li>
					<li><a href="usersetting.php"><i class=""></i> User Profile</a>
                       
                        <li class="divider"></li>
                        <li><a href="logout.php"><i class=""></i> Logout</a>
                        </li>
                    
                <li>
                        <a  href="settings.php"><i class=""></i>Rooms Status</a>
                    </li>
					<li>
                        <a  class="active-menu" href="room.php"><i class=""></i>Add Room</a>
                    </li>
                    <li>
                        <a  href="roomdel.php"><i class=""></i> Delete Room</a>
                    </li>
